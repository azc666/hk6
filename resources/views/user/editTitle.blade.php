...
{!! Form::open(['data-parsley-validate' => '', 'route' => 'showEditTitle', 'method' => 'patch']) !!}     <br>  
</div>
<br>

<div class="col-md-10 col-md-offset-1">
    <h3 class="move-up text-center">Edit Title</h3>

    <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-id-card fa-lg" aria-hidden="true" data-toggle="tooltip" title="This field is required"></i>&nbsp;&nbsp;Title ID:</span>
    ...
    <div class="input-group move-down">
        ...
        {{ Form::text('title_title', $title->title, ['class' => 'form-control', 'placeholder' => 'Title Description']) }}
    </div>
    <br>
{{ Form::hidden('title_id', $title->id) }}
{{ Form::submit('Update Title', ['class' => 'col-sm-5 btn btn-success move-down pull-left']) }}
 {{-- <br> --}}
{!! Form::close() !!}

<a href="{{ route('titles') }}" class="col-sm-5 btn btn-danger move-down move-right pull-right" style="display:inline-block" role="button"> Cancel Update </a>
</div>
</div>
@endsection
